 ...
 */
public class DF10 implements DynamicProblem {
    ...
    */
    ...
    public void costFunction(Individual ind) {
        ...
        f[0] = g * Math.pow(Math.sin(0.5d * Math.PI * ind.getPosition()[0]),H);
        f[1] = g * Math.pow(Math.sin(0.5d * Math.PI * ind.getPosition()[1]) * Math.cos(0.5d * Math.PI * ind.getPosition()[0]),H);
        f[2] = g * Math.pow(Math.cos(0.5d * Math.PI * ind.getPosition()[1]) * Math.cos(0.5d * Math.PI * ind.getPosition()[0]),H);
